...
var opConsoleApp = angular.module("opConsoleApp", [
  "ngRoute",
  "ui.bootstrap",
  "ui.router",
  "angular-jwt",
    ...
    function (
      ...
      $stateProvider
        ...
        .state("op-console.voxbone-number-configuration", {
          ...
          templateUrl:
            "app/views/voxbone-number-config/voxboneNumberConfigMain.html",
          data: {
            requireLogin: true,
          },
        })
...
opConsoleApp.run([
  "$anchorScroll",
  function ($anchorScroll, $rootScope, loginService, $location, $state) {
...
opConsoleApp.filter("secondsToDateTime", [
  function () {
