 ...
 (function () {
     ...
     opConsoleApp.factory('userService', function ($http, baseUrls) {
         ...
         var getAllPackages = function () {
             return $http({
                 method: 'GET',
                 url: baseUrls.packageServiceBaseUrl + 'Packages'
             }).then(function (resp) {
                 return resp.data;
             });
         };
         ...
         var createNewPackage = function (veeryPackage) {
             return $http({
                 method: 'POST',
                  url: baseUrls.packageServiceBaseUrl + 'Package',
         ...
         var updatePackage = function (veeryPackage) {
             return $http({
                 method: 'PUT',
                 url: baseUrls.packageServiceBaseUrl + 'Package/' + veeryPackage.packageName,
                 data: veeryPackage
             }).then(function (resp) {
                 return resp.data;
             });
         ...
         var removePackage = function (veeryPackageName) {
             return $http({
                 method: 'DELETE',
                 url: baseUrls.packageServiceBaseUrl + 'Package/' + veeryPackageName
             }).then(function (resp) {
                 return resp.data;
             });
         };
         ...
         var getAllUnits = function () {
             return $http({
                 method: 'GET',
                 url: baseUrls.packageServiceBaseUrl + 'PackageUnits'
             }).then(function (resp) {
                 return resp.data;
             });
         };
         ...
         var createNewUnit = function (veeryUnit) {
             return $http({
                 method: 'POST',
                 url: baseUrls.packageServiceBaseUrl + 'PackageUnit',
                 data: veeryUnit
             }).then(function (resp) {
                 return resp.data;
             });
         ...
         var updateUnit = function (veeryUnit) {
             return $http({
                 method: 'PUT',
                 url: baseUrls.packageServiceBaseUrl + 'PackageUnit/' + veeryUnit.unitName,
                 data: veeryUnit
             }).then(function (resp) {
                 return resp.data;
             });
         ...
         var removeUnit = function (veeryUnitName) {
             return $http({
                 method: 'DELETE',
                 url: baseUrls.packageServiceBaseUrl + 'PackageUnit/' + veeryUnitName
             }).then(function (resp) {
                 return resp.data;
             });
         };
         ...
         var createNewCompany = function (company) {
             return $http({
                 method: 'POST',
                 url: baseUrls.authUrl + 'auth/signup',
                 data: company
             }).then(function (resp) {
                 return resp.data;
             }).catch(function (ex) {
